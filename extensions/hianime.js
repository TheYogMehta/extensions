...
async function fetchRecentEpisodes(filters = {}) {
  return scrapeCardPage(
    `${baseUrl}/filter?${new URLSearchParams(filters).toString()}`
  );
}
...
async function getSources(embed_url) {
  var __awaiter =
    (this && this.__awaiter) ||
  ...
  var crypto = crypto_1.webcrypto;

  return __awaiter(void 0, void 0, void 0, function () {
    function isDetached(buffer) {
      if (buffer.byteLength === 0) {
        var formatted = util.format(buffer);
        ...
        wbg: {
          ...
          __wbg_localStorage_3d538af21ea07fcc: function () {
            return applyToWindow(function (index) {
              var data = fake_window.localStorage;
              if (isNull(data)) {
                return 0;
              } else {
          ...
          __wbg_get_8986951b1ee310e0: function (index, decode1, decode2) {
            var data = get(index)[decodeSub(decode1, decode2)];
          ...
          __wbg_eval_c824e170787ad184: function () {
            return applyToWindow(function (index, offset) {
              var fake_str = "fake_" + decodeSub(index, offset);
              var ev = eval(fake_str);
          ...
          __wbindgen_closure_wrapper123: function (Qn, QT) {
            var test = addToStack(args(Qn, QT, 9, export4));
            return test;
          },
        },
      };
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          wasmLoader = Object.assign(loadWasm, { initSync: QZ }, grootLoader);
          V = function (url) {
            return __awaiter(void 0, void 0, void 0, function () {
              var Q0;
              return __generator(this, function (_a) {
                switch (_a.label) {
                  ...
                  case 1:
                    ...
                    return [2 /*return*/, fake_window.navigate()];
                }
              });
            });
          };
          getMeta = function (url) {
            return __awaiter(void 0, void 0, void 0, function () {
              var resp, txt, regx, match, content;
              var _a;
              return __generator(this, function (_b) {
                switch (_b.label) {
                  case 0:
                  ...
                  case 2:
                    ...
                    match =
                      (_a = txt.match(regx)) === null || _a === void 0
                        ? void 0
                        : _a[0];
                    content = match.slice(match.lastIndexOf('"') + 1);
          ...
          xrax = embed_url.split("/").pop().split("?").shift();
          regx = /https:\/\/[a-zA-Z0-9.]*/;
          base_url = embed_url.match(regx)[0];
          nodeList.image.src = base_url + "/images/image.png?v=0.0.9";
          _a = Uint8ClampedArray.bind;
          return [4 /*yield*/, pixels(nodeList.image.src)];
        case 1:
          data = new (_a.apply(Uint8ClampedArray, [void 0, _b.sent().data]))();
          ...
          fake_window.G = xrax;
          return [4 /*yield*/, getMeta(embed_url)];
        case 2:
          _b.sent();
          return [4 /*yield*/, V(base_url + "/images/loading.png?v=0.0.9")];
        case 3:
          Q5 = _b.sent();
          getSourcesUrl = "";
        ...
        case 5:
          resp_json = _b.sent();
          Q3 = fake_window.localStorage.kversion;
          Q1 = z(Q3);
          ...
          res = resp_json;
          str = btoa(String.fromCharCode.apply(null, new Uint8Array(Q8)));
